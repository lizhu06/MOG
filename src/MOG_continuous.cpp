...
// [[Rcpp::export]]
void update_gamma1_mc(double pi1, double sigma2, int C, int P,  
...
// [[Rcpp::export]]
void update_gamma2_mc(Eigen::VectorXd& pi2_rep_per_group, double sigma2, int G, 
  int P, Eigen::VectorXi& g_index, Eigen::VectorXi& c_index_group, Eigen::VectorXd& m_gc, 
  Eigen::VectorXd& gamma_1_rep_per_feature, 
...
// [[Rcpp::export]]
void update_gamma3_mc(Eigen::VectorXd& pi3_rep_per_feature, double sigma2, int P, 
  ...
  beta = gamma_3.array() * tailvec.array();
...
// [[Rcpp::export]]
void update_b_mc(Eigen::VectorXd& pi3_rep_per_feature, double sigma2, 
...
// [[Rcpp::export]]
double update_pi1_mc(Eigen::VectorXd& gamma_1, 
...
// [[Rcpp::export]]
void update_pi2_mc(Eigen::VectorXd& gamma_2, Eigen::VectorXd& pi2,
...
// [[Rcpp::export]]
void update_pi3_mc(Eigen::VectorXd& gamma_3, Eigen::VectorXd& pi3, 
...
// [[Rcpp::export]]
double update_sigma2_mc(double N, double alpha_sigma, double beta_sigma,
  Eigen::VectorXd& gamma_1_rep_per_feature, Eigen::VectorXd& gamma_2_rep_per_feature,
  Eigen::VectorXd& gamma_3, Eigen::VectorXd& beta, Eigen::VectorXd& Y, Eigen::MatrixXd& X) {
...
// [[Rcpp::export]]
void update_s2_mc(int P, double alpha_s, double beta_s,
...
// [[Rcpp::export]]
Rcpp::List MCMC_mc(int seed, int burnInIter, int keepIter, 
  ...
  Eigen::VectorXd& s2,
  Eigen::VectorXd& Y, Eigen::MatrixXd& X, int print_int, 
  ...
  Eigen::MatrixXd GAMMA_3(P, keepIter);
  ...
  for(int i = 0; i < totalIter; i++){
    update_gamma1_mc(pi1, sigma2, C, P, c_index, 
    ...
    update_gamma2_mc(pi2_rep_per_group, sigma2, G, 
    ...
    update_gamma3_mc(pi3_rep_per_feature, sigma2, P, 
      c_index, g_index, m_fg, gamma_1_rep_per_feature, 
      gamma_2_rep_per_feature, 
      gamma_3, b, beta, Y, X,
      weight_Tj_int, weight_for_Tj, weight_Rj_int, weight_for_Rj);
    
    update_b_mc(pi3_rep_per_feature, sigma2, s2_vec, P, 
      c_index, gamma_1_rep_per_feature, gamma_2_rep_per_feature, 
      gamma_3, b, beta, Y, X, weight_s2_int, weight_for_s2);
  
    pi1 = update_pi1_mc(gamma_1, alpha1, beta1, C, G);
    
    update_pi2_mc(gamma_2, pi2, c_index_group, m_gc, alpha2, beta2, C, G,
    ...
    update_pi3_mc(gamma_3, pi3, g_index, m_fg, alpha3, beta3, G, P,
      weight_Tj_int, weight_for_Tj, 
    ...
    sigma2 = update_sigma2_mc(N, alpha_sigma, beta_sigma,
      gamma_1_rep_per_feature, gamma_2_rep_per_feature, 
      gamma_3, beta, Y, X);
    
    update_s2_mc(P, alpha_s, beta_s, uni_types, types, b, 
      weight_s2_int, weight_for_s2, s2);
    for(int p = 0; p < P; p++){
      int index = types[p] - 1;
      s2_vec[p] = s2[index];
    }
